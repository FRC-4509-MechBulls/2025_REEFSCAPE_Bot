...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign); // 0 for feedforwards
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.1).withKI(0).withKD(0)
        .withKS(0).withKV(0.124); // for I, D, and S
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.457763671875);
    ...
    private static final boolean kFrontRightEncoderInverted = false; // false
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.0400390625);
    private static final boolean kBackLeftSteerMotorInverted = true;
    private static final boolean kBackLeftEncoderInverted = false; // false
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.401611328125);
    private static final boolean kBackRightSteerMotorInverted = true;
    private static final boolean kBackRightEncoderInverted = false; // false
